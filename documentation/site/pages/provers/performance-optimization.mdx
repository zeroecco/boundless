...
```sh [Terminal]
RUST_LOG=info cargo run --bin boundless-cli -- -f /path/to/elf -i /path/to/input`
```
...
```sh [Terminal]
RUST_LOG=info cargo run --bin boundless-cli -- -c <ITERATION_COUNT>
```
...
```sh [Terminal]
RUST_LOG=info cargo run --bin boundless-cli -- -c 1024
```

```txt [Terminal]
2024-10-17T15:27:34.469227Z  INFO boundless-cli: image_id: a0dfc25e54ebde808e4fd8c34b6549bbb91b4928edeea90ceb7d1d8e7e9096c7 | input_id: 3740ebbd-3bef-475f-b23d-6c2bf96c6551
2024-10-17T15:27:34.479904Z  INFO boundless-cli: STARK job_id: 895a996b-b0fa-4fc8-ae7a-ba92eeb6b0b1
2024-10-17T15:27:34.480919Z  INFO boundless-cli: STARK Job running....
....
2024-10-17T15:27:56.509275Z  INFO boundless-cli: STARK Job running....
2024-10-17T15:27:58.513718Z  INFO boundless-cli: Job done!
```
...
```sh [Terminal]
RUST_LOG=info cargo run --bin boundless-cli -- -c 4096
```

```txt [Terminal]
2024-10-17T15:58:15.205138Z  INFO boundless-cli: image_id: a0dfc25e54ebde808e4fd8c34b6549bbb91b4928edeea90ceb7d1d8e7e9096c7 | input_id: fe7f4251-25f4-436f-b782-f134d4c80538
2024-10-17T15:58:15.210646Z  INFO boundless-cli: STARK job_id: bbf442eb-40db-44fb-8df4-f13a8ce10bf2
2024-10-17T15:58:15.211686Z  INFO boundless-cli: STARK Job running....
....
```
