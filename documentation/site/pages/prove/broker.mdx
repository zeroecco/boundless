...
The Broker is a service that runs within the [Bento](/prove/proving-stack#what-is-bento) proving stack. It is responsible for market interactions including bidding on jobs, locking them, issuing job requests to the Bento proving cluster, and submitting proof fulfillments on-chain.
...
Please refer to the [Deployments](/deployments) page for the correct Boundless market contract address.
...
Please see [Installing the Boundless CLI](/build/request-a-proof#installing-the-boundless-cli) for instructions.
:::
...
:::warning[Warning]
A Broker needs a [Bento](/prove/proving-stack#what-is-bento) instance to operate. Please follow the [quick start](/prove/quick-start) guide to get Bento up and running.
:::
