...
Built-in proivders are are listed in the [`BuiltinStorageProvider`](https://docs.rs/boundless-market/latest/boundless_market/storage/enum.BuiltinStorageProvider.html).
...
- The guest may be panicking or otherwise failing to complete the job.
  ...
  If your request is submitted onchain, you can use the following command to execute it locally.
  If it succeeds, this is not the issue.
