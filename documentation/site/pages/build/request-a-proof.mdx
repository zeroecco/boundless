...
# let boundless_client = ClientBuilder::default().build().await?;
...
input:
  inputType: Inline
  data: "00576564204a756c2020332031343a33373a31322050445420323032340a"
...
offer:
  ...
  lockinStake: 5000000000000000000 # 5 Hitpoint Tokens
```
...
export BOUNDLESS_MARKET_ADDRESS="0x69c7943DA0D7e45D44Bd0cE7a2412DCdAe423788"
export SET_VERIFIER_ADDRESS="0xEf0A93B2310d52358F1eCA0C946aD7D25596e7dd"
