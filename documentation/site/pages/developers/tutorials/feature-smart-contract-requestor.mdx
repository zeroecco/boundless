...
# async fn example(
#     boundless_client: &'static Client<impl alloy::providers::Provider + Clone, impl boundless_market::storage::StorageProvider>,
...
<StripRustCodeComments>
```rust
# use boundless_market::contracts::{ProofRequest, Requirements, Predicate, Offer, RequestId};
