...
impl DBPoolManager<Sqlite> for DbPool<Sqlite> {
    async fn new(conn_str: &str) -> Result<DbPool<Sqlite>, DbError> {
...
#[cfg(test)]
impl From<Pool<Sqlite>> for DbPool<Sqlite> {
...
#[async_trait]
impl BrokerDb for DbPool<Sqlite> {
