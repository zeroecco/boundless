...
impl RequestParams {
    ...
    ///
    /// ```rust
    /// # use boundless_cli_sdk::request_builder::RequestParams;
    /// # const ECHO_ELF: &[u8] = b"";
    ...
    pub fn require_request_id(&self) -> Result<&RequestId, MissingFieldError> {
        self.request_id.as_ref().ok_or(MissingFieldError::with_hint(
            "request_id",
            "can be set using .with_request_id(...), and can be generated by boundless_cli_sdk::Client",
        ))
    }
    ...
    ///
    /// ```rust
    /// # use boundless_cli_sdk::request_builder::{RequestParams, OfferParams};
    ...
    ///
    /// ```rust
    /// # use boundless_cli_sdk::request_builder::{RequestParams, RequirementParams};
