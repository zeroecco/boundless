...
interface IBoundlessMarket {
    ...
    /// @notice Event when prover stake is slashed for failing to fulfill a request by the deadline.
    ...
    event ProverSlashed(RequestId indexed requestId, uint256 stakeBurned, uint256 stakeTransferred);
